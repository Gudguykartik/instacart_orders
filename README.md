...
* [Data Exploration](https://github.com/Gudguykartik/instacart_orders/blob/main/notebooks/Instacart-Simple-Data-Exploration.ipynb): Exploring the raw datasets.
* [Customer Segmentation](https://github.com/Gudguykartik/instacart_orders/blob/main/notebooks/Customer-Segments-with-PCA.ipynb): Segmenting the customers with Principal Component Analysis and K-Means Clustering.
* [Association Rule Mining](https://github.com/Gudguykartik/instacart_orders/blob/main/notebooks/Association-Rule-Mining.ipynb): Applying the Apriori algorithm to mine association rules between orders and customers.
